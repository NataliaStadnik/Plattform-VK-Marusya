...
import {Raiting} from '@/shared'
import {RandomMovieType} from '@/api'
import DashBoardButtons from './DashBoardButtons'
import {useClickOutside, usePathname} from '@/hooks'
import {VideoModal} from '@/entities'
...
const DashBoard: FC<DashBoardViewProps> = ({data, refetch}) => {
  ...
  const ref = useClickOutside('backdrop-video', () => setVideo(false))
